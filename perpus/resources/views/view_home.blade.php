...
@section('isihalaman')
    ...
    <p>
    <h4>Perpustakaan</h4>
        Perpustakaan Perguruan Tinggi UNDIKNAS merupakan Perguruan Tinggi yang bersama-sama 
    ...
    <p>
    <h4>Perpustakaan UNDIKNAS</h4>
        Perpustakaan UNDIKNAS sebagai salah satu perpustakaan perguruan tinggi swasta di Bali 
		...
		referensi lain guna menunjang proses pembelajaran di UNDIKNAS.
