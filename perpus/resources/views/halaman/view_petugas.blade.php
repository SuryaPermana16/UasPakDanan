...
@section('isihalaman')
    <h3><center>Daftar Petugas Perpustakaan UNDIKNAS</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formpetugastaedit" id="formpetugasedit" action="/petugas/edit/{{ $p->id_petugas}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" placeholder="Masukkan Nama Petugas" value="{{ $p->nama_petugas}}">
                                                </div>
                                            </div>
