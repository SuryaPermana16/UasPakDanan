...
@section('isihalaman')
    <h3><center>Daftar Buku Perpustakaan UNDIKNAS</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formbukuedit" id="formbukuedit" action="/buku/edit/{{ $bk->id_buku}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="kode_buku" name="kode_buku" placeholder="Masukan Kode Buku" value="{{ $bk->id_buku}}">
                                                </div>
                                            </div>
